...
import type { TimeLog,TimeBreak,ApiStaff } from '../types/api';

interface AuthenticationProps {
  staff: ApiStaff;
  onAuthSuccess: (TimeLog?: TimeLog[]) => void;
  onBack: () => void;
  theme: Theme;
}
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!!authResult) {
        ...
        /*let timelog: TimeLog[] = [{
          ID: 0,
          CheckInTime: '1970-01-01T00:00:00',
          CheckOutTime: '1970-01-01T00:00:00',
          TotalHours: 0,
          TimeBreaks: []
        }];*/
        console.log('Authentication successful:', authResult);
